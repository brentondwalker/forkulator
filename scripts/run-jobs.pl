...
foreach my $s (@service_rates) {
	...
	my $outfile = "testdata/".$q."q_w".$w."_t".$t."_a".$a."_s".$s."_n".$n."_sf".$service_f."_af".$arrival_f;
	my $meansfile = "testdata/".$q."q_job_means_w".$w."_t".$t."_s".$s."_sf".$service_f."_af".$arrival_f.".dat";
